...
model = RandomForestRegressor(min_impurity_decrease=0.001, max_features=0.4, min_samples_leaf = 2, n_estimators=128, random_state = 6174, bootstrap=True, n_jobs = -1)
model = model.fit(x_train,y_train)
print(f'acc = {model.score(x_val,y_val)}')
